...
<body>
    ...
    <section class="elements-area section-padding-100-0">
				...
				<article class="row">
					...
					<div class="form-group">
						<label for="number" class="col-sm-3 control-label">Enter Payee Account Number *</label>
							<div class="col-sm-8">
								<input type="number" name="name1" class="form-control" placeholder="Enter Account number" id="name1" required>
							</div>
					</div>
					<div class="form-group">
